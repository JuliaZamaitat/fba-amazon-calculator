<template>
  <div>
    ...
    <div class="content">
      ...
      <h3>RAIDBOXES</h3>
      <p>
        Wir hosten unsere Website bei RAIDBOXES. Anbieter ist die RAIDBOXES
        GmbH, Hafenstr. 32, 48151 M&uuml;nster (nachfolgend RAIDBOXES) Wenn Sie
        unsere Website besuchen, erfasst RAIDBOXES verschiedene Logfiles
        inklusive Ihrer IP-Adressen.
      </p>
      <p>
        Details entnehmen Sie der Datenschutzerkl&auml;rung von RAIDBOXES:
        <a
          href="https://raidboxes.io/datenschutzerklaerung/"
          target="_blank"
          rel="noopener noreferrer"
          >https://raidboxes.io/datenschutzerklaerung/</a
        >.
      </p>
      <p>
        Die Verwendung von RAIDBOXES erfolgt auf Grundlage von Art. 6 Abs. 1
      ...
      <p>
        ...
        Schreiberhauer Stra&szlig;e 4<br />
        10317 Berlin
      </p>

      <p>
        Telefon: +49(0) 156 785 535 92<br />
        E-Mail: support@firmcatalyst.com
      </p>
      <p>
      ...
      <p>
        ...
        Borlabs - Benjamin A. Bornschein, R&uuml;benkamp 32, 22305 Hamburg (im
        Folgenden Borlabs).
      </p>
      <p>
      ...
      <p>
        Die erfassten Daten werden gespeichert, bis Sie uns zur L&ouml;schung
        auffordern bzw. das Borlabs-Cookie selbst l&ouml;schen oder der Zweck
        f&uuml;r die Datenspeicherung entf&auml;llt. Zwingende gesetzliche
        Aufbewahrungsfristen bleiben unber&uuml;hrt. Details zur
      ...
      <p>
        ...
        gesetzlich vorgeschriebenen Einwilligungen f&uuml;r den Einsatz von
        Cookies einzuholen. Rechtsgrundlage hierf&uuml;r ist Art. 6 Abs. 1 lit.
        c DSGVO.
      </p>
